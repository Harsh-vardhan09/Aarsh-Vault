...
this will use blockchain to make the certificate untamperable and give authenticity and the person can directly send the certificate to person on there id created using mail.

it will also save the certificate of person on there profile whose link they can share like linkdin and this can be used by recruiter to recongnize official certification

person can also post other pdf of certificate and download there own but those willnot be varified if not from the source themselves
